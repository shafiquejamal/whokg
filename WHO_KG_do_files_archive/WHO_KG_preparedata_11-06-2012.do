...
label var exemptfromcopayment "Exempt from copayment according to response to question a8 and other responses"
...
rename asset57 mobilephone
label var asset60 "Satellite antenna (binary indicator)"
rename asset60 satelliteantenna
